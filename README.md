...
In the next exercise, you will create an **Ansible inventory** containing `rhel1` through `rhel4` and use Ansible's `ping` module to verify all four systems at once.

### Task 5 – Add another user

Add a fourth user to:
